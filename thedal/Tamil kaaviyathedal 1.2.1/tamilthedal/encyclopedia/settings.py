...
DATABASE_NAME = '/home/5gtech/webapps/tamilthedal2/encyclopedia/thedal.db'             # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_ROOT, "templates")#"/home/nanditha/projects/tamilthedal/trunk/src/encyclopedia/templates" 
